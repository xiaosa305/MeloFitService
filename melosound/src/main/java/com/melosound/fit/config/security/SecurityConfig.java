    	...
    	http
                .authorizeRequests(authorizeRequests ->
                        authorizeRequests
                                ...
                                .antMatchers("/api-public/getUserInfo","api-public/checkAccessTokenEnable").hasAnyRole("MANAGER","FITTER","CLIENT","SUPERADMIN")
                                .antMatchers("/test/**","/api-jwttoken/**").permitAll()
                                .antMatchers("/api-public/**","/index.html","/view/**").anonymous()
//                                .antMatchers("/api-public/login","/api-public/test","/api-public/checkServerStatus").anonymous()
